module tb_cpu_top();
	...
	task Manual(input [3:0] addr,input [7:0] data);
	begin	
	...
	initial begin 
		...
		Layer(3'b111);
		#10;
		Manual(4'd0,8'b10011111);
		Manual(4'd1,8'b01110100);
		Manual(4'd2,8'b11100000);
		Manual(4'd3,8'b01100000);
		Manual(4'd4,8'b11110000);
		Manual(4'd5,8'b00000000);
		#10;
		Layer_load;
		Start;
		#100;$stop;
